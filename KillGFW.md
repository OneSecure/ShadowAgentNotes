...
(小白不要恐慌, 只要您看得懂中文, 有初中英文水平, 有支付宝账号, 您就可以在十分钟之内购买一个美国虚拟主机并且在它上面搭好 Shadowsocks 服务器。您看本教程洋洋洒洒似乎极其繁琐，其实只是讲清了两件事：㈠用支付宝租用了美国虚拟主机，㈡在虚拟主机上搭建 Shadowsocks 服务器。租用主机时，按照图一步一步走，最后支付宝付款；安装SS时，点3下鼠标就完事。) 
...
* 便宜，比购买各种专卖VPN的商家便宜得多，当然如果您非要说网上能搜到很多免费账号我也无话可说，我劝您马上关闭这个网页。
* 安全，只要您不把您虚拟主机的IP地址泄漏出去被 GFW 截获，就不会被封，而VPN商家的那些主机由于用户成份复杂，被封就是它们的宿命。
